...
Canvas {
    ...
    //Magic
        ...
        gradient2.addColorStop(0.5, "white");   //oben
        gradient2.addColorStop(0.48, "white");   //oben
        //gradient2.addColorStop(0.47, "white");   //mitte
        gradient2.addColorStop(0.43, "transparent");   //unten
